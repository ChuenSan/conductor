...
/// Local cost scans synchronously walk and parse session archives. Keep that work off Swift's
/// cooperative executor and serialize overlapping refreshes so menus, RPC handlers, and other
/// async tasks do not compete with a large disk scan.
public enum CostUsageScanExecutor {
    public static let queueLabel = "app.conductor.cost-usage-scan"
