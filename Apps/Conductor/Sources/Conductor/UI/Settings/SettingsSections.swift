...
struct GhosttyConfigReferenceCard: View {
    @Environment(\.conductorFontScale) private var fontScale
    @Environment(\.conductorTheme) private var theme
...
struct GhosttyFunctionalConfigBrowser: View {
...
struct GhosttySettingsCategoryRow: View {
...
struct GhosttyConfigFunctionSection: View {
    let renderer: TerminalRendererPreferences
    let group: GhosttyConfigFunctionGroup
    let updateOverrideValue: (String, String) -> Void
    let updateOverrideEnabled: (String, Bool) -> Void
...
struct GhosttyStyledConfigRow: View {
    let key: String
