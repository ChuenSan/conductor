...
enum TerminalTheme: String, CaseIterable, Codable, Identifiable {
    ...
    var terminalRaisedBackground: Color {
        ...
        case .stoneVeil:
            Color(red: 0.182, green: 0.192, blue: 0.204)
        case .harborFog:
            Color(red: 0.130, green: 0.178, blue: 0.220)
        case .clayAsh:
            Color(red: 0.196, green: 0.176, blue: 0.158)
        case .lichenMist:
            Color(red: 0.138, green: 0.184, blue: 0.160)
        case .flexoki:
        ...
        case .paperCanvas:
            Color(red: 0.944, green: 0.948, blue: 0.954)
        case .ember:
    ...
    var terminalChrome: Color {
        ...
        case .stoneVeil:
            Color(red: 0.220, green: 0.232, blue: 0.246)
        case .harborFog:
            Color(red: 0.160, green: 0.220, blue: 0.270)
        case .clayAsh:
            Color(red: 0.236, green: 0.210, blue: 0.186)
        case .lichenMist:
            Color(red: 0.170, green: 0.228, blue: 0.198)
        case .flexoki:
        ...
        case .paperCanvas:
            Color(red: 0.978, green: 0.980, blue: 0.984)
        case .ember:
    ...
    var terminalBackground: Color {
        ...
        case .stoneVeil:
            Color(red: 0.166, green: 0.176, blue: 0.188)
        case .harborFog:
            Color(red: 0.118, green: 0.162, blue: 0.200)
        case .clayAsh:
            Color(red: 0.182, green: 0.160, blue: 0.142)
        case .lichenMist:
            Color(red: 0.122, green: 0.164, blue: 0.142)
        case .flexoki:
    ...
    var windowBackdropStops: [Color] {
        ...
        case .codexDark:
            [
                Color(red: 0.078, green: 0.088, blue: 0.106),
                Color(red: 0.048, green: 0.056, blue: 0.072),
                Color(red: 0.028, green: 0.034, blue: 0.046)
            ]
        case .slateDusk:
            [
        ...
        case .stoneVeil:
            [
                Color(red: 0.300, green: 0.318, blue: 0.340),
                Color(red: 0.226, green: 0.242, blue: 0.266),
                Color(red: 0.150, green: 0.162, blue: 0.182)
            ]
        case .harborFog:
            [
                Color(red: 0.260, green: 0.330, blue: 0.386),
                Color(red: 0.190, green: 0.260, blue: 0.315),
                Color(red: 0.118, green: 0.164, blue: 0.206)
            ]
        case .clayAsh:
            [
                Color(red: 0.348, green: 0.294, blue: 0.250),
                Color(red: 0.266, green: 0.222, blue: 0.190),
                Color(red: 0.174, green: 0.150, blue: 0.130)
            ]
        case .lichenMist:
            [
                Color(red: 0.260, green: 0.326, blue: 0.286),
                Color(red: 0.190, green: 0.258, blue: 0.220),
                Color(red: 0.122, green: 0.166, blue: 0.142)
            ]
        case .flexoki:
            [
                Color(red: 0.972, green: 0.952, blue: 0.904),
        ...
        case .graphite:
            [
                Color(red: 0.886, green: 0.898, blue: 0.914),
                Color(red: 0.792, green: 0.812, blue: 0.836),
                Color(red: 0.652, green: 0.676, blue: 0.704)
            ]
        case .paperCanvas:
            [
                Color(red: 0.998, green: 0.998, blue: 1.000),
                Color(red: 0.962, green: 0.966, blue: 0.972),
                Color(red: 0.900, green: 0.908, blue: 0.918)
            ]
        case .ember:
            [
    ...
    var windowBackdropWash: Color {
        ...
        case .stoneVeil:
            Color(red: 0.58, green: 0.64, blue: 0.72).opacity(0.080)
        case .harborFog:
            Color(red: 0.38, green: 0.66, blue: 0.86).opacity(0.095)
        case .clayAsh:
            Color(red: 0.74, green: 0.50, blue: 0.34).opacity(0.085)
        case .lichenMist:
            Color(red: 0.42, green: 0.70, blue: 0.48).opacity(0.085)
        case .flexoki:
        ...
        case .paperCanvas:
            Color(red: 0.32, green: 0.64, blue: 0.94).opacity(0.12)
        case .ember:
    ...
    var shellPanelBackground: Color {
        ...
        case .codexDark:
            Color(red: 0.094, green: 0.104, blue: 0.124).opacity(0.98)
        case .slateDusk:
        ...
        case .stoneVeil:
            Color(red: 0.190, green: 0.202, blue: 0.218).opacity(0.968)
        case .harborFog:
            Color(red: 0.145, green: 0.196, blue: 0.240).opacity(0.968)
        case .clayAsh:
            Color(red: 0.210, green: 0.184, blue: 0.162).opacity(0.968)
        case .lichenMist:
            Color(red: 0.154, green: 0.202, blue: 0.174).opacity(0.968)
        case .flexoki:
        ...
        case .paperCanvas:
            Color(red: 0.930, green: 0.934, blue: 0.940).opacity(0.94)
        case .ember:
    ...
    var shellPanelStrong: Color {
        ...
        case .codexDark:
            Color(red: 0.120, green: 0.132, blue: 0.156).opacity(0.96)
        case .slateDusk:
        ...
        case .stoneVeil:
            Color(red: 0.230, green: 0.244, blue: 0.262).opacity(0.968)
        case .harborFog:
            Color(red: 0.178, green: 0.238, blue: 0.286).opacity(0.968)
        case .clayAsh:
            Color(red: 0.250, green: 0.220, blue: 0.194).opacity(0.968)
        case .lichenMist:
            Color(red: 0.186, green: 0.238, blue: 0.206).opacity(0.968)
        case .flexoki:
        ...
        case .paperCanvas:
            Color(red: 1.000, green: 1.000, blue: 1.000).opacity(0.96)
        case .ember:
    ...
    var floatingPanelBase: Color {
        ...
        case .codexDark:
            Color(red: 0.132, green: 0.144, blue: 0.170).opacity(0.985)
        case .slateDusk:
        ...
        case .stoneVeil:
            Color(red: 0.216, green: 0.230, blue: 0.248).opacity(0.982)
        case .harborFog:
            Color(red: 0.166, green: 0.222, blue: 0.270).opacity(0.982)
        case .clayAsh:
            Color(red: 0.236, green: 0.206, blue: 0.180).opacity(0.982)
        case .lichenMist:
            Color(red: 0.174, green: 0.226, blue: 0.196).opacity(0.982)
        case .flexoki:
        ...
        case .paperCanvas:
            Color(red: 0.972, green: 0.974, blue: 0.978).opacity(0.968)
        case .ember:
    ...
    var floatingPanelWash: Color {
        ...
        case .stoneVeil:
            Color(red: 0.58, green: 0.64, blue: 0.72).opacity(0.050)
        case .harborFog:
            Color(red: 0.36, green: 0.62, blue: 0.82).opacity(0.056)
        case .clayAsh:
            Color(red: 0.70, green: 0.50, blue: 0.36).opacity(0.052)
        case .lichenMist:
            Color(red: 0.40, green: 0.66, blue: 0.46).opacity(0.052)
        case .flexoki:
        ...
        case .paperCanvas:
            Color(red: 0.32, green: 0.64, blue: 0.94).opacity(0.040)
        case .ember:
    ...
    var floatingStroke: Color {
        ...
        case .harborFog:
            Color(red: 0.58, green: 0.78, blue: 0.94).opacity(0.145)
        case .clayAsh:
            Color(red: 0.86, green: 0.68, blue: 0.52).opacity(0.135)
        case .lichenMist:
            Color(red: 0.62, green: 0.84, blue: 0.64).opacity(0.135)
        case .flexoki:
        ...
        case .paperCanvas:
            Color(red: 0.105, green: 0.120, blue: 0.145).opacity(0.115)
        case .ember:
    ...
    var floatingEmphasis: Color {
        ...
        case .codexDark:
            Color(red: 0.34, green: 0.58, blue: 0.96)
        case .slateDusk:
        ...
        case .stoneVeil:
            Color(red: 0.66, green: 0.70, blue: 0.76)
        case .harborFog:
            Color(red: 0.50, green: 0.72, blue: 0.88)
        case .clayAsh:
            Color(red: 0.76, green: 0.60, blue: 0.46)
        case .lichenMist:
        ...
        case .graphite:
            Color(red: 0.18, green: 0.47, blue: 0.92)
        case .paperCanvas:
            Color(red: 0.300, green: 0.600, blue: 0.920)
        case .ember:
    ...
    var shellStroke: Color {
        ...
        case .stoneVeil:
            Color.white.opacity(0.112)
        case .harborFog:
            Color(red: 0.56, green: 0.76, blue: 0.94).opacity(0.140)
        case .clayAsh:
            Color(red: 0.84, green: 0.66, blue: 0.50).opacity(0.130)
        case .lichenMist:
            Color(red: 0.58, green: 0.78, blue: 0.58).opacity(0.128)
        case .flexoki:
        ...
        case .paperCanvas:
            Color(red: 0.105, green: 0.120, blue: 0.145).opacity(0.120)
        case .ember:
    ...
    var shellChromeText: Color {
        ...
        case .paperCanvas:
            Color(red: 0.105, green: 0.112, blue: 0.125)
        case .ember:
    ...
    var terminalOuterStroke: Color {
        ...
        case .stoneVeil:
            Color.white.opacity(0.190)
        case .harborFog:
            Color(red: 0.56, green: 0.78, blue: 0.98).opacity(0.280)
        case .clayAsh:
            Color(red: 0.88, green: 0.66, blue: 0.48).opacity(0.250)
        case .lichenMist:
            Color(red: 0.56, green: 0.82, blue: 0.58).opacity(0.240)
        case .flexoki:
        ...
        case .paperCanvas:
            Color(red: 0.390, green: 0.680, blue: 0.940).opacity(0.72)
        case .ember:
    ...
    var accent: Color {
        ...
        case .codexDark:
            Color(red: 0.30, green: 0.56, blue: 0.96)
        case .slateDusk:
        ...
        case .harborFog:
            Color(red: 0.46, green: 0.70, blue: 0.88)
        case .clayAsh:
            Color(red: 0.78, green: 0.54, blue: 0.36)
        case .lichenMist:
            Color(red: 0.48, green: 0.72, blue: 0.48)
        case .flexoki:
    ...
    var ghosttyConfig: String {
        ...
        case .stoneVeil:
            ...
            cursor-color = #a8b0bd
            cursor-text = #2a2d30
            selection-background = #474d55
            selection-foreground = #f5f7fa
            """
        case .harborFog:
            """
            palette = 0=#17232c
        ...
        case .clayAsh:
            ...
            cursor-color = #d09a6f
            cursor-text = #2e2925
            selection-background = #54483f
            selection-foreground = #f8efe8
            """
        case .lichenMist:
            """
            palette = 0=#172019
            ...
            cursor-color = #8fcf8a
            cursor-text = #1f2a24
            selection-background = #3d5343
            selection-foreground = #f1fbf3
            """
        case .flexoki:
            """
            palette = 0=#100f0f
        ...
        case .paperCanvas:
            ...
            cursor-color = #4f9fe8
            cursor-text = #fcfcfd
            selection-background = #dbeeff
            selection-foreground = #17191c
            """
        case .ember:
            """
            palette = 0=#160d0a
